""" 
    ...
    files to your old website. ftplib to run uploads in scripts either after or during page file creation.
    ########################################################################################################
"""

import os
servername   = 'kms-py.com'                 # where site is relocating to
homedir      = 'home'                       # where site will be rooted
